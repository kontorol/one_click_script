...
function installXUI(){
    ...
    if compareRealIpWithLocalIp "${configSSLDomain}" ; then
        ...
        wget -O x_ui_install.sh -N --no-check-certificate "https://raw.githubusercontent.com/kontorol/x-ui/develop/install.sh" && chmod +x x_ui_install.sh && ./x_ui_install.sh
